...
<main class="main">
    ...
    <section class="show-info">
        <div class="container page-bg-top">
            <div class="section-block__info">
               ...
               <?php echo get_field('first_text', 32)?>
                </div>
            </div>
        </div>
    </section>
        ...
        <div class="container page-bg-top">
            ...
            <div class="hall__photo">
                <div class="hall__photo-item w-32">
                    <img src="<?php bloginfo('template_url'); ?>/assets/img/rotunda-1.jpg" alt=""
                        class="hall__photo-img">
                </div>
                <div class="hall__photo-item w-32">
                    <img src="<?php bloginfo('template_url'); ?>/assets/img/rotunda-2.jpg" alt=""
                        class="hall__photo-img">
                </div>
                <div class="hall__photo-item w-32">
                    <img src="<?php bloginfo('template_url'); ?>/assets/img/rotunda-3.jpg" alt=""
                        class="hall__photo-img">
                </div>
            </div>
        </div>
    ...
    <section class="show-info">
        <div class="container page-bg-top">
            <div class="section-block__info">
                <div class="section-block__item">
                <?php echo get_field('second_text', 32)?>
                </div>
            </div>
        </div>
    </section>
        ...
        <div class="container page-bg-top">
            <div class="hall__photo">
                <div class="hall__photo-item w-49">
                    <img src="<?php bloginfo('template_url'); ?>/assets/img/rotunda-4.jpg" alt=""
                        class="hall__photo-img">
                </div>
                <div class="hall__photo-item w-49">
                    <img src="<?php bloginfo('template_url'); ?>/assets/img/rotunda-5.jpg" alt=""
                        class="hall__photo-img">
                </div>
            </div>
        </div>
    ...
    <section class="show-info">
        <div class="container page-bg-top">
            <div class="section-block__info">
                <div class="section-block__item">
                <?php echo get_field('third_text', 32)?>
                </div>
            </div>
        </div>
    </section>
    <section class="hall">
        <div class="container page-bg-top">
            <div class="hall__photo">
                <div class="hall__photo-item w-32">
                    <img src="<?php bloginfo('template_url'); ?>/assets/img/rotunda-6.jpg" alt=""
                        class="hall__photo-img">
                </div>
                <div class="hall__photo-item w-66">
                    <img src="<?php bloginfo('template_url'); ?>/assets/img/rotunda-7.jpg" alt=""
                        class="hall__photo-img">
                </div>
            </div>
        </div>
    ...
    <section class="show-info">
        <div class="container page-bg-top">
            <div class="section-block__info">
                <div class="section-block__item">
                <?php echo get_field('fourth_text', 32)?>
              </div>
            </div>
        </div>
    </section>
